...
class Seq2SeqModel(object):
    ...
    def __init__(self, buckets, isTraining, max_gradient_norm, batch_size,learning_rate, learning_rate_decay_factor,attribs):
        ...
        self.encoder = Encoder(isTraining, attribs)
        self.decoder = SimpleDecoder(isTraining, attribs)
